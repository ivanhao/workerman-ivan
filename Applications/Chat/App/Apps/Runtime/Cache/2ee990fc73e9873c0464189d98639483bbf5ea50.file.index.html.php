<?php /* Smarty version Smarty-3.1.6, created on 2016-05-05 09:59:01
         compiled from "./Apps/Home/View/Index/index.html" */ ?>
<?php /*%%SmartyHeaderCode:1959333075572aa7fd187a87-12786292%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '2ee990fc73e9873c0464189d98639483bbf5ea50' => 
    array (
  ...
  'nocache_hash' => '1959333075572aa7fd187a87-12786292',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.6',
  'unifunc' => 'content_572aa7fd9d09c',
  'has_nocache_code' => false,
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_572aa7fd9d09c')) {function content_572aa7fd9d09c($_smarty_tpl) {?><html><head>
...
/jquery.min.js"></script>
  ...
  <script type="text/javascript">
    ...
    WEB_SOCKET_SWF_LOCATION = "<?php echo @SWF_URL;?>
/WebSocketMain.swf";
    ...
    function connect() {
       // 创建websocket
       ws = new WebSocket("ws://cradle.jios.org:7272");
       // 当socket连接打开时，输入用户名
       ws.onopen = onopen;
       // 当有消息时根据消息类型显示不同信息
    ...
    function onopen()
    {
        ...
        // 登录
        var login_data = '{"type":"login","client_name":"'+name.replace(/"/g, '\\"')+'","room_id":"<<?php ?>?php echo isset($_GET['room_id']) ? $_GET['room_id'] : 1?>"}';
    ...
    <div class="container">
	    <div class="row clearfix">
	        ...
	        <div class="col-md-6 column">
               ...
               &nbsp;&nbsp;&nbsp;&nbsp;<b>房间列表:</b>（当前在&nbsp;房间<<?php ?>?php echo isset($_GET['room_id'])&&intval($_GET['room_id'])>0 ? intval($_GET['room_id']):1; ?>）<br>
